...
# brms_cov_model: function for running brms models with a covariance matrix (such as animal models)
...
```{r examples-brms_cov_model, warning=FALSE, message=FALSE}
